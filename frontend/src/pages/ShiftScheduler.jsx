...
const psoPayload = {
  "2026-04-07": { "Ward 3": { staffId: "EMP005", shift: "Morning" }, "Ward 5": { staffId: "EMP006", shift: "Evening" }, "Ward 8": { staffId: "EMP008", shift: "Night" }, "Ward 9": { staffId: "EMP012", shift: "Evening" } },
  "2026-04-08": { "Ward 1": { staffId: "EMP004", shift: "Evening" }, "Ward 2": { staffId: "EMP011", shift: "Morning" }, "Ward 4": { staffId: "EMP001", shift: "Morning" }, "Ward 6": { staffId: "EMP009", shift: "Night" }, "Ward 10": { staffId: "EMP007", shift: "Morning" } },
  "2026-04-09": { "Ward 2": { staffId: "EMP002", shift: "Evening" }, "Ward 3": { staffId: "EMP011", shift: "Evening" }, "Ward 5": { staffId: "EMP006", shift: "Evening" }, "Ward 7": { staffId: "EMP009", shift: "Morning" }, "Ward 9": { staffId: "EMP012", shift: "Evening" }, "Ward 10": { staffId: "EMP007", shift: "Morning" } },
  "2026-04-10": { "Ward 1": { staffId: "EMP004", shift: "Morning" }, "Ward 3": { staffId: "EMP005", shift: "Morning" }, "Ward 4": { staffId: "EMP011", shift: "Morning" }, "Ward 6": { staffId: "EMP009", shift: "Night" }, "Ward 8": { staffId: "EMP011", shift: "Evening" }, "Ward 10": { staffId: "EMP007", shift: "Morning" } },
  "2026-04-11": { "Ward 2": { staffId: "EMP008", shift: "Night" }, "Ward 9": { staffId: "EMP012", shift: "Evening" } },
  "2026-04-12": { "Ward 3": { staffId: "EMP008", shift: "Night" }, "Ward 4": { staffId: "EMP001", shift: "Morning" }, "Ward 5": { staffId: "EMP006", shift: "Evening" }, "Ward 7": { staffId: "EMP001", shift: "Morning" }, "Ward 8": { staffId: "EMP002", shift: "Evening" }, "Ward 10": { staffId: "EMP007", shift: "Morning" } },
  "2026-04-13": { "Ward 2": { staffId: "EMP011", shift: "Morning" }, "Ward 3": { staffId: "EMP011", shift: "Morning" }, "Ward 7": { staffId: "EMP009", shift: "Morning" }, "Ward 9": { staffId: "EMP012", shift: "Evening" } }
};
...
const ShiftScheduler = () => {
  ...
  useEffect(() => {
    const handleKeyDown = (e) => {
      ...
      if (e.key === 't' || e.key === 'T') setWeekStart(getMonday(new Date('2026-04-07')));
    };
    ...
    setTimeout(() => {
      setAllShifts(prev => {
        ...
        activeDays.forEach(({ dateStr }) => {
          ...
          if (psoPayload[dateStr]) {
            Object.entries(psoPayload[dateStr]).forEach(([w, payload]) => {
              if (!state[dateStr][w]) state[dateStr][w] = payload; // Fill empty only
            });
          }
        });
        return state;
      ...
      setOpenPso(false);
      showToast('✅ PSO Algorithm complete — 31 shifts auto-assigned for Apr 7–13');
    }, 2000);
  };
  ...
  const exportPDF = async () => {
    ...
    pdf.save(`schedule_apr7_2026.pdf`);
    ...
    <Box>
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={1}>
        ...
        <Box display="flex" alignItems="center" gap={1}>
          ...
          <Button variant="outlined" size="small" onClick={() => setWeekStart(getMonday(new Date('2026-04-07')))}>Today</Button>
        </Box>

        <Box display="flex" gap={2}>
          <Button variant="outlined" color="primary" startIcon={<MenuIcon/>} onClick={() => setDrawerOpen(true)}>Staff Load</Button>
          <Button variant="contained" color="secondary" startIcon={<AutoGraphIcon />} onClick={() => setOpenPso(true)}>Auto-Schedule (PSO)</Button>
        </Box>
      </Box>
                      ...
                      return (
                        <>
                          ...
                          <Box display="flex" justifyContent="space-between" alignItems="flex-end" mt="auto">
                            <Box sx={{ display: 'inline-block', px: 1, py: 0.25, borderRadius: 4, fontSize: '10px', fontWeight: 'bold', 
      ...
      <Box sx={{ position: 'sticky', bottom: 0, bgcolor: 'rgba(255, 255, 255, 0.95)', backdropFilter: 'blur(8px)', 
      ...
      <Dialog open={openPso} onClose={() => {if(!isPsoLoading) setOpenPso(false)}} maxWidth="sm" fullWidth>
        ...
        <DialogContent dividers>
          {isPsoLoading ? (
            ...
            <Typography>
              Auto-schedule will fill all EMPTY cells for the week of {formatDate(weekStart)} – {formatDate(weekEnd)}.<br/><br/>
              Existing assignments will NOT be overwritten.<br/>
              <b>Continue?</b>
            </Typography>
          )}
        </DialogContent>
